...
class Ui_Dialog(object):#UI
    ...
    def setupUi(self, Dialog):
        ...
        #点击时的操作
        self.pushButton_2.clicked.connect(self.paizhao)#点击时进行拍照，并选择文件
        self.pushButton.clicked.connect(lambda: self.face(self.img))#点击时运行face
